...
class SSUSettings(QtWidgets.QDialog):
    def __init__(self, parent=None):
        ...
        self.optimizer_label.setToolTip(self.tr("The optimizer to find the minimum value of the loss function."))
        ...
        self.try_global_checkbox.setToolTip(self.tr("Try global optimization or local optimization."))
        ...
        self.global_max_niter_label.setToolTip(self.tr(
            "Maximum number of iterations of global optimization for termination."))
        ...
        self.global_niter_success_label.setToolTip(self.tr(
            "The number of iterations that reaching the same local optimal value for termination."))
        ...
        self.global_step_size_label.setToolTip(self.tr("The step size of searching global optimal value."))
        ...
        self.optimizer_max_niter_label.setToolTip(self.tr(
            "Maximum number of iterations of the optimizer of global and local optimization."))
        ...
        self.need_history_checkbox.setToolTip(self.tr("Record the variation history of parameters."))
