...
class FittingResultViewer(QDialog):
    ...
    def save_excel(self, filename, align_components=False):
        ...
        description = \
            ...
            3. The third sheet is the statistic moments of all samples.
        ...
        for row, result in enumerate(results, 2):
            ...
            for component in result.components:
                ...
                write(row, index*len(sub_headers)+3, component.logarithmic_moments["std"], style=style)
                write(row, index*len(sub_headers)+4, component.logarithmic_moments["skewness"], style=style)
                write(row, index*len(sub_headers)+5, component.logarithmic_moments["kurtosis"], style=style)
                flag_index += 1
