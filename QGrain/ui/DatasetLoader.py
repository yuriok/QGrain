...
class DatasetLoader(QtWidgets.QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.start_row_label = QtWidgets.QLabel(self.tr("Distributions Start Row"))
        ...
        self.start_column_label = QtWidgets.QLabel(self.tr("Distributions Start Column"))
    ...
    def on_try_load_clicked(self):
        try:
            ...
            result = load_dataset(self._filename, self.sheet_index, **self.data_layout, progress_callback=callback)
    ...
    def retranslate(self):
        ...
        self.start_row_label.setText(self.tr("Distributions Start Row"))
        self.start_column_label.setText(self.tr("Distributions Start Column"))
