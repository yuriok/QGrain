...
class EMMAResultChart(BaseChart):
    ...
    def __init__(self, parent=None, figsize=(4.4, 4.4)):
        ...
        self.loss_menu: QtWidgets.QMenu = QtWidgets.QMenu(self.tr("Loss Function"))
        ...
        for key, name in self.supported_losses:
            loss_action: QtGui.QAction = self.loss_group.addAction(name)
        ...
        for interval, name in self.supported_intervals:
            interval_action: QtGui.QAction = self.interval_group.addAction(name)
