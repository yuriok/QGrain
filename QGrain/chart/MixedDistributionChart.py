__all__ = ["MixedDistributionChart"]
...
class MixedDistributionChart(BaseChart):
    def __init__(self, parent=None, figsize=(4, 4), show_mode=True):
        ...
        for key, name in self.supported_scales:
            ...
            scale_action.triggered.connect(lambda: self.update_chart())
        ...
        for interval, name in self.supported_intervals:
            ...
            interval_action.triggered.connect(lambda: self.update_animation())
