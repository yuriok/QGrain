...
class SSUTypicalComponentChart(QDialog):
    ...
    def show_typical(self, results: typing.Iterable[SSUResult]):
        if len(results) == 0:
            return
        ...
        for result in results:
            for component in result.components:
                ...
                if has_nan:
                    continue
                data_to_clustering.append([component.moments[key] for key in keys_to_clustering])
