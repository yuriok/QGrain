...
class AlgorithmSetting(QWidget):
    ...
    def init_ui(self):
        ...
        self.global_maxiter_label = QLabel(self.tr("Global Optimization\nMax Iteration"))
        ...
        self.global_success_iter_label = QLabel(self.tr("Global Optimization\nSuccess Iteration"))
        ...
        self.global_stepsize_label = QLabel(self.tr("Global Optimization\nStepsize"))
        ...
        self.minimizer_tolerance_level_label = QLabel(self.tr("Global Minimizer\nTolerance Level"))
        ...
        self.minimizer_maxiter_label = QLabel(self.tr("Global Minimizer\nMax Iteration"))
        ...
        self.final_tolerance_level_label = QLabel(self.tr("Final Fitting\nTolerance Level"))
        ...
        self.final_maxiter_label = QLabel(self.tr("Final Fittingg\nMax Iteration"))
