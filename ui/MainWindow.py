...
class MainWindow(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.loss_canvas_action = QAction(QIcon("./settings/icons/canvas.png"), self.tr("Loss Canvas"), self)
        ...
        self.raw_data_table_action = QAction(QIcon("./settings/icons/raw_table.png"), self.tr("Raw Data Table"), self)
        self.docks_menu.addAction(self.raw_data_table_action)
        self.recorded_data_table_action = QAction(QIcon("./settings/icons/recorded_table.png"), self.tr("Recorded Data Table"), self)
